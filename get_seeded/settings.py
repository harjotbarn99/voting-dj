"""
Django settings for get_seeded project.
...
SECRET_KEY = 'p+6q&_=q3py2m+e&4l9@^5km(a81)*pvo7$s(*n)apbo4q+i^g'
...
WSGI_APPLICATION = 'get_seeded.wsgi.application'
